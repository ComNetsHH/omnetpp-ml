...
// Based on: https://github.com/PatWie/tensorflow-cmake/blob/master/examples/simple/example.cc
...
Define_Module(TFModule);

void TFModule::initialize() {
    ...
    EV_INFO << outputs[0].matrix<float>();
}
